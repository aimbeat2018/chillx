...
//        CleverTapAPI.setDebugLevel(CleverTapAPI.LogLevel.VERBOSE);
        ...
        try {
            ...
            SharedPreferences sharedPreferences = PaymentResultActivity.this.getSharedPreferences(ott.chillx.utils.Constants.USER_AGE, MODE_PRIVATE);
