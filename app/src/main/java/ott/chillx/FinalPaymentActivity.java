...
import ott.chillx.adapters.MyListAdapter;
import ott.chillx.adapters.MyListData;
...
import ott.chillx.onepay.Constants;
import ott.chillx.onepay.PaymentActivity;
        ...
        rec_age.addOnItemTouchListener(
                new PackageAdapter.RecyclerItemClickListener(FinalPaymentActivity.this, rec_age, new PackageAdapter.RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        ott.chillx.adapters.MyListAdapter.ViewHolder viewHolder = (ott.chillx.adapters.MyListAdapter.ViewHolder) rec_age.getChildViewHolder(view);
...
//        dialog.show();
    ...
    public void fetch_stripe_Payment_data(String strip_plan_amount) {
        ...
        String url = "https://chillx.in/chillx_backoffice/rest-api/v130/stripe_payment";
...
//            paymentstartedAction.put("Days", aPackage.getDay());
        ...
        lnrPhonePay.setOnClickListener(view -> {
            if (pkgAppsList.size() == 0) {
                ...
                Intent intent = new Intent(FinalPaymentActivity.this, PhonepayKotline.class);
...
//            paymentstartedAction.put("Days", aPackage.getDay());
        ...
        card_subpaisa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                // Intent intent = new Intent(FinalPaymentActivity.this, EaseBuzz.class);
                Intent intent = new Intent(FinalPaymentActivity.this, SubpaisaActivity.class);
                intent.putExtra("package", aPackage);
                intent.putExtra("currency", "currency");
