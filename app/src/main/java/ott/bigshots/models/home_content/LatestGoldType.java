...
public class LatestGoldType {
    ...
    @SerializedName("is_gold_paid")
    @Expose
    private String isGoldPaid;
    ...
    public String getIsGoldPaid() {
        return isGoldPaid;
    }

    public void setIsGoldPaid(String isGoldPaid) {
        this.isGoldPaid = isGoldPaid;
    }
