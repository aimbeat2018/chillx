...
package ott.bigshots.models.home_content;
...
import ott.bigshots.database.homeContent.converters.CountryConverter;
import ott.bigshots.database.homeContent.converters.FeaturedTvConverter;
import ott.bigshots.database.homeContent.converters.FeaturesGenreConverter;
import ott.bigshots.database.homeContent.converters.GenreConverter;
import ott.bigshots.database.homeContent.converters.GoldConverter;
import ott.bigshots.database.homeContent.converters.LatestMovieConverter;
import ott.bigshots.database.homeContent.converters.PopularMovieConverter;
import ott.bigshots.database.homeContent.converters.PopularStarsConverter;
import ott.bigshots.database.homeContent.converters.SliderTypeConverter;
import ott.bigshots.database.homeContent.converters.TvSeriesConverter;
