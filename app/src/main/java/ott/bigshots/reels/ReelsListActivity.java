...
import ott.bigshots.DetailsActivity;
import ott.bigshots.R;
import ott.bigshots.SearchGridAdapter;
import ott.bigshots.SubscriptionActivity;
import ott.bigshots.adapters.InactiveSubscriptionAdapter;
import ott.bigshots.databinding.ActivityReelsListBinding;
import ott.bigshots.databinding.ItemReelsBinding;
import ott.bigshots.firebaseservice.Config;
import ott.bigshots.models.ReelsModel;
import ott.bigshots.network.OnReelsVideoAdapterListner;
import ott.bigshots.network.RetrofitClient;
import ott.bigshots.network.apis.ReelsApi;
