...
import ott.bigshots.adapters.DownloadHistoryAdapter;
import ott.bigshots.adapters.DownloadedVideoListAdapter;
import ott.bigshots.adapters.FileDownloadingAdapter;
...
import ott.bigshots.models.ItemMovie;
import ott.bigshots.models.VideoFile;
import ott.bigshots.models.Work;
import ott.bigshots.nav_fragments.DownloadNewFragment;
...
//                activity.getSupportFragmentManager().beginTransaction().replace(R.id.Container, myFragment).addToBackStack(null).commit();
                ...
                ott.bigshots.database.DatabaseHelper offlineDatabaseHelper1 = new DatabaseHelper(DownloadActivity.this);
