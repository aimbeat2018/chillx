...
import ott.istream.AppConfig;
import ott.istream.MainActivity;
...
ProgressBar progressBar;
    ...
    private ott.istream.database.DatabaseHelper databaseHelper;
...
//        CleverTapAPI.setDebugLevel(CleverTapAPI.LogLevel.VERBOSE);
        ...
        try {
            ...
            SharedPreferences sharedPreferences = PaymentResultActivity.this.getSharedPreferences(ott.istream.utils.Constants.USER_AGE, MODE_PRIVATE);
...
//        Toolbar toolbar = findViewById(R.id.toolbar);
        ...
        if (getIntent() != null) {
            ...
            databaseHelper = new ott.istream.database.DatabaseHelper(this);
        }
        ...
        call.enqueue(new Callback<ActiveStatus>() {
            ...
            public void onResponse(Call<ActiveStatus> call, retrofit2.Response<ActiveStatus> response) {
                if (response.code() == 200) {
                    ...
                    ott.istream.database.DatabaseHelper db = new ott.istream.database.DatabaseHelper(getApplicationContext());
