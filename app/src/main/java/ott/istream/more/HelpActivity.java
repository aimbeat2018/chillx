...
import ott.istream.MoreActivity;
...
//                System.out.println("OnItemClickListener ==> listData ==> " + "8291030554");
                startActivity(intent);
            }
        });
    ...
    private void sendEmail() {
        ...
        String to[] = {"customercare@istream.in"};
        ...
        emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Istream Customer Query ");
