...
import ott.istream.adapters.MyListAdapter;
import ott.istream.adapters.MyListData;
...
import ott.istream.network.apis.PaymentGatewayApi;
...
import ott.istream.network.model.SubscriptionHistory;
import ott.istream.network.model.User;
import ott.istream.onepay.Constants;
import ott.istream.onepay.PaymentActivity;
        ...
        rec_age.addOnItemTouchListener(
                new PackageAdapter.RecyclerItemClickListener(FinalPaymentActivity.this, rec_age, new PackageAdapter.RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        ott.istream.adapters.MyListAdapter.ViewHolder viewHolder = (ott.istream.adapters.MyListAdapter.ViewHolder) rec_age.getChildViewHolder(view);
...
//        dialog.show();
    ...
    public void fetch_stripe_Payment_data(String strip_plan_amount) {
        ...
        String url = "https://istreamm.com/istreamm_backoffice/rest-api/v130/stripe_payment";
