...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    //    public static final String DATABASE_NAME = "ott.istream.db";
    public static final String DATABASE_NAME = "ott.istream.db";
