...
import ott.istream.adapters.PackageAdapter;
import ott.istream.bottomshit.PaymentBottomShitDialog;
import ott.istream.database.DatabaseHelper;
import ott.istream.network.apis.PackageApi;
import ott.istream.network.apis.PaymentApi;
import ott.istream.network.apis.SubscriptionApi;
import ott.istream.network.model.ActiveStatus;
import ott.istream.network.model.AllPackage;
import ott.istream.network.model.Package;
import ott.istream.network.model.User;
import ott.istream.network.model.config.PaymentConfig;
...
//        startActivity(intent);
   ...
   /* @Override
    ...
    public void getToken(final String orderId, final String amount) {
        dialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, /*"https://primeplay.co.in/webworld_backoffice/rest-api/v130/cashfree"*/"https://istreamm.com/istreamm_backoffice/rest-api/v130/cashfree_test"/*"https://test.cashfree.com/api/v2/cftoken/order"*/, new com.android.volley.Response.Listener<String>() {
            @Override
