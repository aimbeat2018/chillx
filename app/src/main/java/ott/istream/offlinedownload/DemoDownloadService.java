package ott.istream.offlinedownload;
...
import ott.istream.constant.AppUtil;
...
//        PendingIntent pendingIntentPause = PendingIntent.getService(this, 100, pIntentPause, PendingIntent.FLAG_UPDATE_CURRENT);
...
//        PendingIntent pendingIntentCancel = PendingIntent.getService(this, 100, pIntentStartCancel, PendingIntent.FLAG_UPDATE_CURRENT);
        ...
        switch (download.state) {
            ...
            case Download.STATE_DOWNLOADING:
                ...
                Notification notificationDownloading = new NotificationCompat.Builder(context, channelId)
                        ...
                        .setSmallIcon(R.drawable.ppapplogo)
