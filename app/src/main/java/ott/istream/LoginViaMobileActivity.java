...
public class LoginViaMobileActivity extends AppCompatActivity {
    ...
    LinearLayoutCompat lnrPassword;
...
//        }
        ...
        btnReset.setOnClickListener(v -> {
            ...
            lnrPassword.setVisibility(View.VISIBLE);
            ...
            public void onResponse(Call<User> call, Response<User> response) {
                if (response.code() == 200) {
                    ...
                    if (response.body().getStatus().equalsIgnoreCase("success")) {
                        User user = response.body();
                        ott.istream.database.DatabaseHelper db = new DatabaseHelper(LoginViaMobileActivity.this);
                        db.deleteUserData();
                        db.insertUserData(user);
                        ApiResources.USER_PHONE = user.getPhone();
