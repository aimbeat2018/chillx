...
import ott.istream.databinding.ActivityReelsListBinding;
import ott.istream.databinding.ItemReelsBinding;
import ott.istream.models.ReelsModel;
import ott.istream.network.OnReelsVideoAdapterListner;
import ott.istream.network.RetrofitClient;
import ott.istream.network.apis.ReelsApi;
...
//        player = ExoPlayerFactory.newSimpleInstance(this, trackSelector);
        ...
        CacheDataSourceFactory cacheDataSourceFactory = new CacheDataSourceFactory(simpleCache, new DefaultHttpDataSourceFactory(Util.getUserAgent(ReelsListActivity.this, "Istream"))
                , CacheDataSource.FLAG_IGNORE_CACHE_ON_ERROR);
        ProgressiveMediaSource progressiveMediaSource = new ProgressiveMediaSource.Factory(cacheDataSourceFactory).createMediaSource(Uri.parse(videoUrl));
        binding.playerView.setPlayer(player);
        player.setPlayWhenReady(true);
...
//                progressBar.setVisibility(View.GONE);
    ...
    private MediaSource hlsMediaSource(Uri uri, Context context) {
        ...
        DataSource.Factory dataSourceFactory = new DefaultDataSourceFactory(context,
                Util.getUserAgent(context, "istream"), bandwidthMeter);
