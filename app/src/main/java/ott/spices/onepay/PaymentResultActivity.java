...
ProgressBar progressBar;
    ...
    private ott.spices.database.DatabaseHelper databaseHelper;
...
//        CleverTapAPI.setDebugLevel(CleverTapAPI.LogLevel.VERBOSE);
        ...
        try {
            ...
            SharedPreferences sharedPreferences = PaymentResultActivity.this.getSharedPreferences(ott.spices.utils.Constants.USER_AGE, MODE_PRIVATE);
...
//        Toolbar toolbar = findViewById(R.id.toolbar);
        ...
        if (getIntent() != null) {
            ...
            databaseHelper = new ott.spices.database.DatabaseHelper(this);
        }
        ...
        call.enqueue(new Callback<ActiveStatus>() {
            ...
            public void onResponse(Call<ActiveStatus> call, retrofit2.Response<ActiveStatus> response) {
                if (response.code() == 200) {
                    ...
                    ott.spices.database.DatabaseHelper db = new ott.spices.database.DatabaseHelper(getApplicationContext());
