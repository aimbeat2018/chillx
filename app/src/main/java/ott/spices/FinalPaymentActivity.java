...
import ott.spices.adapters.MyListAdapter;
import ott.spices.adapters.MyListData;
import ott.spices.network.RetrofitClient;
import ott.spices.database.DatabaseHelper;
import ott.spices.network.apis.PaymentApi;
import ott.spices.network.apis.PaymentGatewayApi;
import ott.spices.network.apis.SubscriptionApi;
import ott.spices.network.model.ActiveStatus;
import ott.spices.network.model.Package;
import ott.spices.network.model.SubscriptionHistory;
import ott.spices.network.model.User;
import ott.spices.onepay.Constants;
import ott.spices.onepay.PaymentActivity;
        ...
        rec_age.addOnItemTouchListener(
                new PackageAdapter.RecyclerItemClickListener(FinalPaymentActivity.this, rec_age, new PackageAdapter.RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        ott.spices.adapters.MyListAdapter.ViewHolder viewHolder = (ott.spices.adapters.MyListAdapter.ViewHolder) rec_age.getChildViewHolder(view);
