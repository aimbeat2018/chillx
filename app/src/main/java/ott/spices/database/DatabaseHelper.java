...
import ott.spices.models.Work;
import ott.spices.network.model.ActiveStatus;
import ott.spices.network.model.config.AdsConfig;
import ott.spices.network.model.config.AppConfig;
import ott.spices.network.model.config.Configuration;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    //    public static final String DATABASE_NAME = "ott.spices.db";
    public static final String DATABASE_NAME = "ott.spices.db";
