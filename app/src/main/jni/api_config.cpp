...
std::string SERVER_URL = "https://istreamm.com/istreamm_backoffice/rest-api/";
...
Java_ott_istream_AppConfig_getApiServerUrl(
        JNIEnv *env,
        jclass clazz) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_ott_istream_AppConfig_getApiKey(
        JNIEnv *env,
        jclass clazz) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_ott_istream_AppConfig_getPurchaseCode(
        JNIEnv *env,
        jclass clazz) {
